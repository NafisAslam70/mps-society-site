...
//         return true;
//       } catch (error) {
//         console.error(`Fetch attempt ${attempt} failed:`, error.message, error.stack);
//         if (attempt < retries) {
...
//         websiteFetchError,
//         fetchWebsiteData,
//         refreshWebsiteData, // Added refresh function
//         refreshProjects,
//       }}
//     >
//       {children}
...
export function AppProvider({ children }) {
  ...
  const [isLoadingWebsiteData, setIsLoadingWebsiteData] = useState(true);
  const [websiteFetchError, setWebsiteFetchError] = useState(null);
  const hasFetchedRef = useRef(false); // Prevent re-fetching
